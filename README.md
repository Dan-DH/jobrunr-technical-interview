...
- you can solve the unit tests (details about the coding challenge can be found below) in this repo without the use of internet or local LLM help. This means without using
